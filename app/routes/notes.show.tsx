...
export default function Show() {
  ...
  const data = useRouteLoaderData('routes/notes') as Card[]
  console.log(req)
      ...
      <div className="search">
        <div className="search__box" style={{backgroundColor: selectedColor}}>
          ...
          <input
            ...
            name="title"
          />
          {req?.error?.issues.some((item: any) => item.path.includes("title")) ? <span className="search__error">Titulo obrigatório</span> : null}
          <textarea
          ...
          <div className="search__options">
            <div className="search__icons-wrapper">
              ...
              <svg className="search__color-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" onClick={() => setShowColor(!showColor)}>
                <path fill="#ff15a1" stroke="#373737" strokeWidth=".5" d="M10.5 10.5c.002 2.762-2.237 5-5 5s-5.002-2.238-5-5c-.002-2.76 2.237-5 5-5s5.002 2.24 5 5z" color="#000"/>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="17.5" height="17.5" fill="none" viewBox="0 0 24 24">
                <path stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 12v5M14 12v5M4 7h16M6 10v8a3 3 0 0 0 3 3h6a3 3 0 0 0 3-3v-8M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2H9V5Z"/>
              </svg>
          </div>
          </Form>
        </div>
